       ...
       <div class="p-4 mt-12">
            ...
            <nav class="flex mb-4" aria-label="Breadcrumb">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                    <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-white">{{ __('stepper.apply_edit_step_1') }}</span>
                    </div>
                </li>
                </ol>
            </nav>
            <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">{{ __('stepper.apply_edit_step_1') }}</h2>
            {{-- end header --}}
            ...
            <form action="{{ route('programmeSelect.quickUpdate', ['id' => $APPLICATION_RECORD_ID]) }}" method="post" enctype="multipart/form-data">
                @csrf 
