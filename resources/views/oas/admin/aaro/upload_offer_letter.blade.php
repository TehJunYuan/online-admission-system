<x-app-layout>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-12">
            {{-- header --}}
            <h2 class="mx-2 my-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">{{ __('Upload Offer Letter') }}</h2>
            {{-- end header --}}
            ...
            {{-- table --}}
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" id="myTable">
                    ...
                    <tbody>
                        @foreach ($pending_offer_letter_candidates as $pending_verified_candidate)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4 text-center flex flex-col">
                                    <a href="{{  route('offer_letter.home', ['id' => Crypt::encrypt($pending_verified_candidate->getApplication_record_id())])  }}" class="font-medium text-green-600 dark:text-green-500 hover:underline my-1">{{ __('Upload Offer Letter') }}</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
