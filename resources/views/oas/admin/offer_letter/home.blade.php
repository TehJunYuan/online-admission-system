    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="px-6 col-6">
            <form action="{{ route('offer_letter.create',['id'=>Crypt::encrypt($APPLICATION_RECORD_ID)]) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="file" name="offerLetter" multiple data-max-file-size="5MB" data-max-files="1" data-allow-reorder="true" class="block  text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" required>
                <br>
