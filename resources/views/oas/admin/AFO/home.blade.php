                ...
                <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
                    <dl class="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
                        <div class="flex flex-col items-center justify-center dark:bg-gray-800 py-14">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">{{ $count['count_all_todo_for_afo'] }}</dt>
                            <dd class="font-light text-gray-500 dark:text-gray-400">{{ __('admin.pending_verify_payment') }}</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center dark:bg-gray-800 py-14 ">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">{{ $count['count_all_complete_checking_payment_slip_by_afo'] }}</dt>
                            <dd class="font-light text-gray-500 dark:text-gray-400">{{ __('admin.verified') }}</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center dark:bg-gray-800 py-14">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">{{ $count['count_all_payment_slip_rejected_by_afo'] }}</dt>
                    ...
                    <tbody>
                        @foreach ($all_candidate_profiles as $profile)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('applicationForm.getPayment',['id'=> Crypt::encrypt($profile->getApplication_record_id())]) }}" target="_blank" class="text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-1 text-center inline-flex items-center mr-2 dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:focus:ring-yellow-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
