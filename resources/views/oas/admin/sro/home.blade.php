                ...
                <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
                    <dl class="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
                        <div class="flex flex-col items-center justify-center dark:bg-gray-800 py-14">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">{{ $count['count_all_todo_for_sro'] }}</dt>
                            <dd class="font-light text-gray-500 dark:text-gray-400">{{ __('admin.pending_verify') }}</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center dark:bg-gray-800 py-14 ">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">{{ $count['count_all_complete_checking_application_by_sro'] }}</dt>
                            <dd class="font-light text-gray-500 dark:text-gray-400">{{ __('admin.verified') }}</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center dark:bg-gray-800 py-14">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">{{ $count['count_all_application_rejected_by_sro'] }}</dt>
